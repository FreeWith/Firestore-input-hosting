...
import { doc,setDoc,getFirestore } from "https://www.gstatic.com/firebasejs/10.13.1/firebase-firestore.js";
...
await setDoc(doc(db, "cities", "fukuoka"), {
  name: "nagamasa kuroda",
  state: "kyushu",
  country: "japan"
});